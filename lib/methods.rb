...
def gcd_of_last_digits(int_one, int_two)
  last_digit_one = last_digit(int_one)
  last_digit_two = last_digit(int_two)
  last_digit_one.gcd(last_digit_two)
end
...
def dec_remainder_of_two_floats(f_dividend, f_divisor)
  divisor_result = f_dividend / f_divisor
  divisor_result - divisor_result.floor
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
  ...
  result = dec_remainder * i_divisor
  result.round
end
